...
export default function ResponsiveDrawer(props) {
  ...
  const drawer = (
    <div style={{ marginTop: "30px", textAlign: "center"}}>
      ...
      <p style={{ fontSize: "13px", marginTop: "40px" }}>
      ...
      <List id="list">
        <ListItem disablePadding>
          <ListItemButton>
            <ListItemIcon>
              <img
                src="https://www.staderlabs.com/bnb/_next/static/media/hedera.74f0b8ab.svg"
                alt="images"
                width="15px"
              />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton>
            <ListItemIcon>
              <img
                src="https://www.staderlabs.com/bnb/_next/static/media/polygon.200df3c7.svg"
                alt="images"
                width="15px"
              />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton>
            <ListItemIcon>
              <img
                src="https://www.staderlabs.com/bnb/_next/static/media/fantom.874a1ac6.svg"
                alt="images"
                width="15px"
              />
            </ListItemIcon>
            <ListItemText primary="Fantom" />
          </ListItemButton>
        </ListItem>
        ...
        <ListItem disablePadding>
          <ListItemButton>
            <ListItemIcon>
              <img
                src="https://www.staderlabs.com/bnb/_next/static/media/near.52f5ca81.svg"
                alt="images"
                width="15px"
              />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton>
            <ListItemIcon>
              <img
                src="https://www.staderlabs.com/bnb/_next/static/media/terra.5f74e6a9.svg"
                alt="images"
                width="15px"
              />
            </ListItemIcon>
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Toolbar id="toolbar">
          ...
          <Button variant="contained" id="connect">
            Connect Wallet
          </Button>
